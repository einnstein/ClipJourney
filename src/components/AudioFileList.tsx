      ...
      <div className="flex-1 overflow-y-auto">
        {audioItems.length === 0 ? (
          ...
          audioItems.map(item => (
            <div
              key={item.id}
              className="p-2 border-b border-gray-700 hover:bg-gray-800 cursor-pointer group"
            ...
            >
              <div className="flex items-center justify-between">
                ...
                <button
                  ...
                  className="opacity-0 group-hover:opacity-100 ml-2 px-1 text-red-500 hover:text-red-400"
                >
                  ×
                </button>
              </div>
